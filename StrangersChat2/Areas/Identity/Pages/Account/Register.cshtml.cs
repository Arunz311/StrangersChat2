    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    ModelState.AddModelError(string.Empty, "Email is already taken. Please try another.");
                    return Page();
                }
            ...
            return RedirectToPage("/Index"); // Redirect to your desired page after registration
        }
